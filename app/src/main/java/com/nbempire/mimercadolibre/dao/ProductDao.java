...
public interface ProductDao {
     ...
     *
     * @param sharedPreferences The {@link android.content.SharedPreferences} storage system in where the {@code product} will  be persisted.
     * @param product           The {@link com.nbempire.mimercadolibre.domain.Product} object to store.
     */
