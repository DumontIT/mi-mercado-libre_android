...
public class HomeActivity extends BaseActionBarActivity implements ActionBar.TabListener {
     ...
     *
     * @param settingValue      The setting stored value. You can get that value by doing sharedPreferences.getString({keyName}, "defaultValue").
     * @param valuesResourceId  Resource ID for the string array resource where to look for the specified {@code settingValue}. This resource is set
     *                          in ListPreference definition.
     * @param entriesResourceId Resource ID that contains entries for the specified {@code valuesResourceId}.
